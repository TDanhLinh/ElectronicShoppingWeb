...
// @Override
// public ListResponse<InventoryResponse> findAll(int page, int size, String
// sort, String filter, String search,
// boolean all) {
// return defaultFindAll(page, size, sort, filter, search, all,
// SearchFields.INVENTORY, inventoryRepository,
// inventoryMapper);
// }

// @Override
// public InventoryResponse findById(Long id) {
// return defaultFindById(id, inventoryRepository, inventoryMapper,
...
// Count inventory = inventoryRepository.findById(id)
// .map(existingEntity -> inventoryMapper.partialUpdate(existingEntity,
// request))
// .map(inventoryRepository::save)
// .orElseThrow(() -> new ResourceNotFoundException(ResourceName.INVENTORY,
// FieldName.ID, id));
