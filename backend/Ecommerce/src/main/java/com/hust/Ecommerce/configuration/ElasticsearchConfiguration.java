...
// @WritingConverter
// static class ZonedDateTimeWritingConverter implements
// Converter<ZonedDateTime, String> {
...
// @ReadingConverter
// static class ZonedDateTimeReadingConverter implements Converter<String,
// ZonedDateTime> {
...
// @WritingConverter
// static class LocalDateWritingConverter implements Converter<LocalDate,
// String> {
...
// @ReadingConverter
// static class LocalDateReadingConverter implements Converter<String,
// LocalDate> {
